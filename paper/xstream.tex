...
\begin{figure*}[ht!]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption{spam-sms}
    \end{subfigure}\\
		\caption{Average precision over time for XS-C, XS-W and baseline methods for 5 datasets, with (a)-(b) score-once and (c)-(d) score-all.}
\end{figure*}
...
\begin{figure*}
	...
	\begin{subfigure}[t]{0.45\textwidth}
			...
			\caption{spam-sms}
	\end{subfigure}
	\caption{Effect of varying $d$ and initial sample size $N$ on XS-C (score-all).}
\end{figure*}
